...
var AnimType = {once:0, repeat:1, pingpong:2, extend:3}
...
// Empty file converted from TypeScript
var TAU = Math.PI * 2
...
function createCanvas(x, y){
    ...
    canvas.width = x;
    canvas.height = y;
    // Don't auto-append to body - let caller decide where to place it
...
// This file was commented out in the TypeScript version
class Knot{
    constructor(obj){
        this.edges = []
...
/// <reference path="libs/vector/vector.js" />
/// <reference path="libs/utils/rng.js" />
/// <reference path="libs/utils/store.js" />
/// <reference path="libs/utils/table.js" />
/// <reference path="libs/utils/utils.js" />
/// <reference path="libs/utils/stopwatch.js" />
/// <reference path="libs/utils/ability.js" />
/// <reference path="libs/utils/anim.js" />
/// <reference path="libs/rect/rect.js" />
/// <reference path="libs/event/eventqueue.js" />
/// <reference path="libs/event/eventsystem.js" />
/// <reference path="libs/utils/camera.js" />
/// <reference path="libs/networking/entity.js" />
/// <reference path="libs/networking/server.js" />
...
createButton('ðŸ”„ Reset', e => cube.reset())
createButton('Scramble', e => outputinput.value = cube.scramble())
createButton('ðŸ§  Solve', e => {
    try {
